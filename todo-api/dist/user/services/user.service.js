...
let UserService = class UserService {
    ...
    async create(newUser) {
        ...
        if (emailExists === false && usernameExists === false) {
            ...
            throw new common_1.HttpException('Email ou Nome já está em uso.', common_1.HttpStatus.CONFLICT);
        }
    }
    async login(user) {
        ...
        if (foundUser) {
            ...
            if (passwordsMatching === true) {
                ...
                throw new common_1.HttpException('Login não foi concluido', common_1.HttpStatus.UNAUTHORIZED);
            }
        }
        else {
            throw new common_1.HttpException('Ususario não encontrado', common_1.HttpStatus.NOT_FOUND);
        }
    }
    async getOneById(id) {
